...
$('#submit-btn').click(function () {
    ...
    <br><br>\
    <strong>For introverts, to be alone with our thoughts is as restorative as sleeping, as nourishing as eating.</strong>\n\n\
    <br><br>\
    ...
    <br><br>\
    <strong>When I am among people, I make eye contact, smile, maybe chat if there’s an opportunity (like being stuck in a long grocery store line). As an extrovert, that’s a small ‘ping’ of energy, a little positive moment in the day.</strong>';
    } else {
    ...
    document.querySelector('.subtitle').innerHTML = '~ Nicely done! Now read the report of your quiz result below. ~';
